...
REQUIREMENTS:\n\
  • HRTF data files: 'hrtf-44100-left.dat' and 'hrtf-44100-right.dat' (included with Csound).\n\
  • hrtfearly/hrtfreverb ONLY work at sr=44100. This rig uses 44100.\n\
...
<CsoundSynthesizer>
<CsOptions>
-odac -d --env:SADIR+=/Library/Frameworks/CsoundLib64.framework/Versions/6.0/samples
</CsOptions>
<CsInstruments>

sr = 44100  ; hrtfearly/hrtfreverb only support 44100 Hz
ksmps = 32
nchnls = 2
0dbfs = 1
...
instr 99
  ...
  ; Stage 1: Early reflections — matching exact Csound manual example format
  ; hrtfearly asrc, ksrcx, ksrcy, ksrcz, klstnrx, klstnry, klstnrz,
  ;           Sleft, Sright, idefroom
  ; Listener at (5, 1, 1), source position from GUI
  aeL, aeR, irt60lo, irt60hi, imfp hrtfearly amono, kposx, kposy, kposz, \
    5, 1, 1, "hrtf-44100-left.dat", "hrtf-44100-right.dat", 1

  ; Stage 2: Late diffuse field
  ilowrt  chnget "low_rt60"
  ihighrt chnget "high_rt60"
  alateL, alateR, idel hrtfreverb amono, ilowrt, ihighrt, \
    "hrtf-44100-left.dat", "hrtf-44100-right.dat", 44100, imfp
