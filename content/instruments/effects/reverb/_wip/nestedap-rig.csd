...
groupbox bounds(10, 160, 200, 130) text("NESTED ALLPASS") colour(40, 40, 60) fontColour(200, 200, 220) {
    combobox bounds(15, 30, 170, 22) channel("nap_mode") value(3) text("Mode 1 — Dense", "Mode 2 — Medium", "Mode 3 — Sparse")
    rslider bounds(10, 60, 55, 55) channel("nap_gain") range(0.05, 0.7, 0.3, 1, 0.01) text("Gain") textColour(200,200,220) trackerColour(224, 200, 100)
...
setup_nap:
  ...
  i_mode = (i_mode < 1) ? 1 : i_mode
  i_gain chnget "nap_gain"
  i_gain = (i_gain < 0.05) ? 0.3 : i_gain
  i_del  chnget "nap_delay"
  i_del  = (i_del < 0.005) ? 0.04 : i_del
  i_maxdel = 0.5
  ...
  ; Pre-compute all delay/gain values as named variables
  i_d1a = i_del
  i_g1a = i_gain
  i_d2a = i_del * 0.73
  i_g2a = i_gain * 0.9
  ...
  prints "nestedap A: mode=%d maxdel=%.3f d1=%.4f d2=%.4f d3=%.4f g1=%.2f g2=%.2f g3=%.2f\\n", \
    i_mode, i_maxdel, i_d1a, i_d2a, i_d3a, i_g1a, i_g2a, i_g3a
  prints "nestedap B: d1=%.4f d2=%.4f d3=%.4f\\n", i_d1b, i_d2b, i_d3b

  a1 nestedap ain, i_mode, i_maxdel, i_d1a, i_g1a, i_d2a, i_g2a, i_d3a, i_g3a
  a2 nestedap a1, i_mode, i_maxdel, i_d1b, i_g1b, i_d2b, i_g2b, i_d3b, i_g3b
