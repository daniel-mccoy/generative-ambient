...
groupbox bounds(10, 60, 720, 90) text("TEST SOURCE") colour(40, 40, 60) fontColour(200, 200, 220) {
    ...
    label bounds(375, 28, 340, 40) text("Pings are ideal for hearing the plate resonance. Try noise bursts for full spectral excitation.") fontColour(140, 140, 160) fontSize(9) align("left")
}
